-- Elements Baseball v1.3.46 Build 1 — playable core game persistence
-- Run after 20260818_gameplay_phase1b_pregame_state.sql.
-- Extends the private lab writer for swing/result and simple decision-resolution events.
--
...
comment on function public.save_gameplay_lab_state(uuid, bigint, jsonb, text, jsonb) is
  'Private Gameplay Lab writer for v1.3.46 playable core game events.';
